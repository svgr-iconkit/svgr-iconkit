...
import SVG_circleOn from "./circle-on";
...
import SVG_slidersV from "./sliders-v";
...
import SVG_directionsAlt from "./directions-alt";
import SVG_directions from "./directions";
import SVG_reply from "./reply";
import SVG_fileO from "./file-o";
import SVG_ticket from "./ticket";
import SVG_idCard from "./id-card";
import SVG_compass from "./compass";
import SVG_stepBackwardAlt from "./step-backward-alt";
import SVG_stepForwardAlt from "./step-forward-alt";
...
import SVG_filterSlash from "./filter-slash";
...
import SVG_thumbsDownFill from "./thumbs-down-fill";
import SVG_thumbsUpFill from "./thumbs-up-fill";
...
"directions-alt": SVG_directionsAlt,
...
"id-card": SVG_idCard,
"compass": SVG_compass,
"step-backward-alt": SVG_stepBackwardAlt,
"step-forward-alt": SVG_stepForwardAlt,
"forward": SVG_forward,
...
"sort-alt-slash": SVG_sortAltSlash,
"calculator": SVG_calculator,
"arrows-alt": SVG_arrowsAlt,
"file-word": SVG_fileWord,
"gift": SVG_gift,
"cart-plus": SVG_cartPlus,
"thumbs-down-fill": SVG_thumbsDownFill,
"thumbs-up-fill": SVG_thumbsUpFill,
